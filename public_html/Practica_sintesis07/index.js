...
var divLista8 = document.getElementById("glyphIcon15");
divLista8.innerHTML = "<a style='text-align: center; font-size: 40px'><span class='glyphicon glyphicon-phone'></span></a>";

document.getElementById("juegoprueba").addEventListener('click', function(){
    window.open('Preguntas.html', null,`height=${valorScreenHeight/2}, width=${valorScreenWidth/2}, left=500%, top=200%` );
